...
def _call_ai_for_quiz(
    *, grade: int, topic_name: str, topic_text: str, age: int, ora_szam: int, all_ora_szamok: list[int]
    ...
    system = (
        ...
        f"ABSOLUTE RULE: Child is {age} years old, grade {grade}.\n\n"
        "If grade is 1, 2, 3, or 4: ONLY use simple real-world problems. "
        "Maximum 2-digit numbers. "
        "Example questions: Anna has 8 apples, gives 3 away, how many left? "
        "There are 5 red and 4 blue balls, how many total? "
        "FORBIDDEN: sets theory, combinatorics, abstract math, permutations, Venn diagrams, "
        "3x3 tables, choosing k from n.\n"
        "If topic name contains words like rendszerezés, halmazok, állítások: "
        "still make questions SIMPLE and CONCRETE for the age. "
        "For rendszerezés grade 2: ask about sorting toys by color or size. "
        "For állítások grade 2: true/false about everyday things like A kutya nagyobb mint a macska.\n"
        "NEVER generate university or high school level math regardless of topic name.\n"
