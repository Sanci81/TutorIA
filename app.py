...
def _call_ai_for_quiz(
    *, grade: int, topic_name: str, topic_text: str, age: int, ora_szam: int, all_ora_szamok: list[int]
    ...
    system = (
        ...
        f"The child is {age} years old in grade {grade}. "
        "Create questions that are EXACTLY appropriate for this age - a 9 year old needs questions "
        "about concrete real-world math problems with numbers under 100, "
        "NOT kindergarten-level questions about counting apples. "
        "Base difficulty strictly on the curriculum text provided and the child grade level.\n"
