...
KARTYAK: list[dict] = [
    ...
    },
    {
        ...
        "prompt": "Christopher Columbus, ruddy freckled face, aquiline nose, blue eyes, shoulder-length white hair, clean-shaven, red velvet coat. Holding a brass astrolabe at a ship's rail, both hands fully visible. Behind him and further away, two more caravels sailing in the SAME direction as his own ship, seen from behind at a distance, their square sails bearing the red cross of the 1492 Spanish expedition, pennants flying from the masts.",
    },
    {
    ...
    },
    {
        ...
        "kep": "digitalis_7_turing",
        "ritkasag": 'ritka', "ero": 360,
        "kepesseg": 'Kódfejtés', "kepesseg_ero": 300,
        "becenev": 'A KÓDTÖRŐ',
        "leiras": 'Ő fogalmazta meg, mit jelent egyáltalán az, hogy egy gép „számol”, és ő tette fel a kérdést: gondolkodhat-e egy gép?',
